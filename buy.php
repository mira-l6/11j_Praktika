                            ...
                            <ul class="navbar-nav w-100 services-nav">
                                <li class="nav-item w-100">
                                    <button class="btn w-100">
                                        <a class="nav-link text-start ps-4 removed" href="buy.html">Покупка</a>
                                    </button>
                                </li>
                                <li class="nav-item w-100">
                                    <button class="btn w-100">
                ...
                <form action="/filter.php/" method="post" >
                    <div class="filter-box">
                        ...
                        <div class="filter-option"><label for="max-price">Цена (евро)</label>
                            <input type="number" id="max-price" name="property-filter" placeholder="От..." class="min-price">
                            <input type="number" id="min-price" name="property-filter" placeholder="До..." class="max-price">
                        </div>
                        <div class="line-break"><div></div></div>

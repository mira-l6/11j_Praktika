...
<html lang="bg">
    ...
    <body>
     <!-- nav start -->
                    ...
                    <li class="nav-item">
                        ...
                        <div id="service" class="collapse container-fluid p-0">
                            <ul class="navbar-nav w-100 services-nav">
                                ...
                                <li class="nav-item w-100">
                                    <button class="btn w-100">
                                        <a class="nav-link text-start ps-4 removed" href="rent.html">Наемане</a>
                                    </button>
                                </li>
                                <li class="nav-item w-100">
                                    <button class="btn w-100">
        ...
        <!--nachalo na stranicata-->
        <div class="rent-title-box text-center p-5">
            <h2 class="rent-title p-5">Наемане на апартамент/имот/сграда</h2>
        </div>
